#include<stdio.h>
void Intersection(int d[100],int e[100],int u,int v);
void Union(int a[100],int b[100],int x,int y);
int main()
...
printf("Now Please enter number of students who play cricket: ");
scanf("%d",&n);
